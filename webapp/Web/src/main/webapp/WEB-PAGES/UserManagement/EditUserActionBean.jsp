                ...
                <div class="ibox float-e-margins" style="margin-bottom: 5px">
                    <div class="ibox">
                        ...
                        <div class="ibox-content" style="padding: 15px">
                            <s:form class="m-t" beanclass="id.co.icg.imap.tax.web.user.EditUserActionBean">
                            <div class="row">
                                <label class="col-sm-2 control-label">User Name :</label>
                                <div class="col-sm-4">
                                    <input type="text" name="username" class="form-control input-sm m-b-sm" value="${actionBean.user.username}"/>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <s:select name="kppId" id="kpp" class="form-control m-b-sm" value="${actionBean.user.kpp}" style="width: 316px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <s:submit class="btn btn-primary btn-sm" name="cancel">Cancel</s:submit>
                                </div>
                            </div>
                            </s:form>
                        </div>
